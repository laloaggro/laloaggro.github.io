      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="caption-text text-muted mb-6">
          ...
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wider text-muted mb-4">Navegación</h4>
            <ul className="space-y-3">
              {navItems.map((item) => (
                <li key={item.name}>
                  <Link 
                    href={item.href} 
                    className="body-text text-foreground hover:text-accent transition-colors link-hover"
                  >
                    {item.name}
                  </Link>
                </li>
          ...
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wider text-muted mb-4">Contacto</h4>
            <ul className="space-y-3 body-text text-foreground">
              <li>+56 9 6360 3177</li>
              <li>mauriciogarayveas@gmail.com</li>
